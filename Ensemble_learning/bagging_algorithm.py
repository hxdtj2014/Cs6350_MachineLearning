# Bagging Algorithm A2Q2(b) and (c)
# import the csv file
import numpy as np
import pandas as pd
...
def bagging_algorithm(total_iteration, df1, df2, num_examples):
    ...
    for i in range(total_iteration):
        ...
        trees = decision_tree(random_part, Attr_dict, 16, 0)
...
'''
# ===========================A2Q2(b)=========================================
tt = 500 # set the tree size to be 100 to reduce the computation time

results_train = bagging_algorithm(tt, df, df, 5000)
err_train = results_train[0]

results_test = bagging_algorithm(tt, df, df_t, 5000)
...
plt.plot(iterations, acc_cum_test, label='test_error')
...
for run_time in run_times:
    dec_tr = bagging_algorithm(10, df, df, 1000)
...
for run_time in run_times:
    ...
    results_train = bagging_algorithm(run_time, df, df, 1000)
